...
export declare class CustomButtonEvent {
    image: Image;
...
export declare class Image {
    ...
    constructor(img: string, thumb?: string | null | undefined, description?: string | null | undefined, extUrl?: string | null | undefined, identifier?: string | null | undefined);
}
/**
...
export declare class AngularModalGalleryComponent implements OnInit, OnDestroy, OnChanges {
    ...
    customButtonClicked: EventEmitter<CustomButtonEvent>;
    /**
